% Main ZBA bridge plus the bad-target condition for a finite E255 counterexample.
% f(x,y) means x*y.
...
fof(b_has_no_right_fixer, axiom, ! [X] : f(X,b) != b).

fof(zba_bad_target_bridge, conjecture, f(zb,a) = ib).
